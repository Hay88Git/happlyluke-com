  ...
  const footer = `
        ...
        <div class="container mx-auto">
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-7">
            <div class="py-5 lg:py-10 *:pb-5">
              ...
              <p class="text-white">HapplyLuke chuyên trang cá cược thể thao, lô đề, casino, game slot… uy tín. Happlyluke.com là đại lý chính thức của nhà cái HapplyLuke cung cấp đường link vào nhà cái không bị chặn, gửi tiền, rút tiền  nhanh chóng.</p>
              <ul class="list-disc *:text-white text-2xl pl-10">
                ...
                <li><p class="text-white">Website : https://happlyluke.com</p></li>
              </ul>
            </div>
            <div class="py-5 lg:py-10 *:pb-5">
      ...
      <footer class="bg-slate-800">
        <div class="container mx-auto py-5 lg:py-7">
          <p class="text-center text-white">Bản quyền thuộc HapplyLuke – Happlyluke.com</p>
        </div>
      </footer>
    `;  
  $("#footer").html(footer);
